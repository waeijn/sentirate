...
BURSTY_PERSIST_MAX  = 15
SUSPICIOUS_PERSIST  = 15
...
class HeuristicEngine:
    ...
    def classify(self, monitor: TrafficMonitor) -> TrafficType:
        ...
        if (lam > BURSTY_RATE_MAX or
                burst_freq > SUSPICIOUS_BURST or
                persistence > SUSPICIOUS_PERSIST):
...
NORMAL_PERSIST_MAX  = 5
BURSTY_PERSIST_MIN  = 5
BURSTY_PERSIST_MAX  = 60
SUSPICIOUS_PERSIST  = 60
...
#   per eviction via popleft(). No allocation on the hot path — O(1) amortized.
# =============================================================================
RATE_WINDOW_SECONDS = 1.0   # rolling window duration for λ computation
